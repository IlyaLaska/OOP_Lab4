...
List<selectionList> Waiter::takeOrder(const Client *client, List<selectionList>& clientsOrder, const List<priceList> menu) {
...
List<amountList> Waiter::fillOrders(List<selectionList> &clientsOrder, List<amountList> &orders) {
